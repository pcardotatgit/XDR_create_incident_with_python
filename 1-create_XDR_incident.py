...
observables=demo_data.observables
sighting_relations=demo_data.sighting_relations
incident_title=demo_data.incident_title
...
if __name__ == "__main__":
    ...
    source='XDR Demo'
    confidence = "High"
    title = "Patrick Sighting - event"
    tlp="amber"
    severity = "High"
    #observables=json.loads(observables)
    #targets=json.loads(targets)
    sighting=create_sighting_object(sighting_xid,title,observables,targets,confidence,description,source,tlp,severity)
    print()
